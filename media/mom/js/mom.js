/* 
	...
	http://github.com/getify/LABjs/raw/master/LAB.src.js
	http://github.com/getify/LABjs/raw/master/LAB.min.js
*/

/*!@license

	mom.js
		there's only one thing inside your HEAD: mom
	
	Includes:
		LAB.js (LABjs :: Loading And Blocking JavaScript)
		v1.0.3 (c) Kyle Simpson, MIT License
*/
(function(doc) {
	...
	addClass(ua[1] + " " + ua[1] + ua[2].replace(".", "").substring(0, 2));	
	...
	var root = location.host,
		 ...
		 els = path.split("/"),
		 pageClass = els.slice(0, els.length -1).join("-") || "root";
