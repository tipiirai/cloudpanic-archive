...
(function() {
	...
	function prettytime(date) {
		...
		return diff < 86400 && (
				 ...
				 diff < 3600 && str("_ min", "_ minutes ago", Math.floor( diff / 60 )) ||
				 diff < 7200 && (future ? "<span>1</span> hour" : "1 hour ago") ||
				 diff < 86400 && str("_hours", "_ hours ago", Math.floor(diff / 3600))) ||
